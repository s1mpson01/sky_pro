...
@pytest.mark.parametrize("my_list, parameter, expected",[([
    {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
    {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
...
def test_filter_state_without_key_state():
    assert filter_by_state([{'id': 939719570, 'date': '2018-06-30T02:08:58.425572'},
                                   {'id': 594226727, 'date': '2018-09-12T21:27:25.241689'}], "EXECUTED") == []
...
def test_filter_state_isinstance():
    with pytest.raises(Exception):
        assert filter_by_state({'id': 939723570, 'state': 'EXECUTED', 'date': '20318-06-30T0232:08:58.425572'},
                               'EXECUTED')
